    ...
    <script>
      $(document).ready(function () {
        ...
        var table = $("#myTable").DataTable({
          ...
          language: {
            paginate: {
              next: '<div class="flex justify-end"><button class="px-3 py-1 bg-blue-950 text-white rounded-md focus:outline-none active:bg-blue-500">Next</button></div>',
              previous:
                '<div class="flex justify-end"><button class="px-3 py-1 bg-blue-500 text-white rounded-md focus:outline-none focus:shadow-outline-blue active:bg-blue-950 mr-2">Previous</button></div>',
            },
          },
        });
        ...
        // Menambahkan event listener pada tombol "Previous"
      ...
      // Fungsi pencarian saat tombol "Search" diklik
      function searchTable() {
        var inputText = $("#default-search").val();
        $("#myTable").DataTable().search(inputText).draw();
      }
    </script>
  </body>
</html>